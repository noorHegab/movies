...
Widget buildUpcoming() => Consumer<MainProvider>(
      builder: (context, provider, child) {
        ...
        // Ensure the scroll listener is added once
        if (!provider.scrollController1.hasListeners) {
          provider.scrollController1
              .addListener(provider.scrollListenerUpcoming);
        }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: provider.isLoading && data.isEmpty
                        ? const Center(child: CircularProgressIndicator())
                        : data.isEmpty
                            ? const Center(child: Text('No upcoming releases'))
                            : ListView.builder(
                                controller: provider.scrollController1,
